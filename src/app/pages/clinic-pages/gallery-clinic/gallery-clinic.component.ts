...
@Component({
  selector: 'app-gallery-clinic',
  standalone: true,
  imports: [],
  templateUrl: './gallery-clinic.component.html',
  styleUrls: ['./gallery-clinic.component.scss']
})
export class GalleryClinicComponent implements AfterViewInit {
